...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.qrcode_encode: //生成
                try {
                    if (scanResult != null) {
                        Bitmap mBitmap = QRCodeEncoder.encodeAsBitmap(scanResult, 500);
                        qrcodeImg.setImageBitmap(mBitmap);
                    }else {
                        Toast.makeText(this,"請先掃描，在生成！！",Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
     ...
     * 解析QRcode
     *
     * @param bitmap   要解析 QRcode 的 Image
     */
